package com.example.lenovo.echo.databases
...
class EchoDatabase: SQLiteOpenHelper{
    ...
    object  Staticated{
        val DB_NAME = "NexusFavoriteDatabase"
        var DB_VERSION = 1
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        //Incorrect Sql commands // fixed whitespace missing
        db?.execSQL("CREATE TABLE "+ Staticated.TABLE_NAME+" ( "+ Staticated.COLUMN_ID+ " INTEGER, " + Staticated.COLUMN_SONG_ARTIST+" STRING, " + Staticated.COLUMN_SONG_TITLE+" STRING, "+ Staticated.COLUMN_SONG_PATH+
                " STRING);")
    }
