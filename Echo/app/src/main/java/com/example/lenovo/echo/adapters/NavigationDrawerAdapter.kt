...
import com.example.lenovo.echo.fragments.AboutUsFragment
...
import com.example.lenovo.echo.fragments.SettingFragment
    ...
    override fun onBindViewHolder(holder: NavViewHolder?, position: Int) {
        ...
        holder?.contentHolder?.setOnClickListener {
            if (position==0){
                ...
                val nexusFavoriteFragment = NexusFavoriteFragment()
                (mContext as MainActivity).supportFragmentManager
                        .beginTransaction()
                        .replace(R.id.details_fragment, nexusFavoriteFragment)
                        .commit()
            }else if (position == 2){
